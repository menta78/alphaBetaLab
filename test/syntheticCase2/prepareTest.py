...
casename = 'case2swellonly'
casedisplname = 'case 2'
...
# obstructions
modulusy = np.array([0,1,1,1,1,1,1,0])
ysect = np.tile(modulusy, 10)
obstrsys, = np.where(ysect == 1)
obstrsys = obstrsys + 1
obstrsxs = obstrsys * 0 + lresObstrX*hilowCellsFactor + 6 + 1
