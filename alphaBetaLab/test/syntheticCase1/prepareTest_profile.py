...
alphaMtx = abHighResAlphaMatrix.abHighResAlphaMatrix(hiresxs, hiresys, hiresAlpha)
...
cellEst = abCellsEstimator.abCellsEstimator(grid, alphaMtx, directions, freqs)
cellEst.computeLocalAlphaBeta()
profiler.enable()
cellEst.computeShadowAlphaBeta()
profiler.disable()
